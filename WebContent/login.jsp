            ...
            <div class="btn-area">
               ...
               <button class="memberJoin">
                ...
                <div class="icon">
                    ...
                    <a id="custom-login-btn" href="https://kauth.kakao.com/oauth/authorize?client_id=88bd3e119450cef04c32225563be47fe&redirect_uri=http://localhost:8080/bookstore/kakaologin&response_type=code">
