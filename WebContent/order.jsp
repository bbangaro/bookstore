					...
					<c:otherwise>
						<c:forEach var="cvo" items="${list }">
							<tr>
								...
								<td data-th="Price">${cvo.price }원<br>(할인가 : ${cvo.salePrice }원)</td>
								<td data-th="Quantity">
		...
		<div class="form-card">
            <div class='form-group'>
              <div class='col-xs-12 form-group'>
                ...
                <input id="oname" name="oname" class="form-control" type="text" required="" value="${mvo.userName }">
              </div>
            </div>
            <div class='form-group'>
              <div class='col-xs-12 form-group'>
                <label class="control-label locked" for="ophone-input-field">전화번호</label>
                <input id="ophone" name="ophone" type="text" placeholder="01xxxxxxxxxx" class="form-control locked" required="" value="${mvo.mobilePhone }">
              </div>
            </div>
            <div class='form-group'>
              <div class='col-xs-12 form-group'>
                <label class="control-label locked" for="ozipcode-input-field">우편번호</label>
                <input id="ozipcode" name="ozipcode" type="text" placeholder="xxxxx" class="form-control locked" required="" value="${mvo.zipcode }">
              </div>
            </div>
            <div class="form-group locked">
                <div class='col-xs-12 form-group'>
                    <label class="control-label locked" for="oemail-input-field">Email</label>
                    <input id="oemail" name="oemail" type="text" placeholder="email@email.com" class="form-control locked" required="" value="${mvo.email }">
                </div>
            </div>
            <div class="form-group locked">
                <div class='col-xs-12 form-group'>
                    <label class="control-label locked" for="oaddress-input-field">주소</label>
                    <textarea name="oaddress" id="oaddress" cols="0" rows="3" class="form-control locked">${mvo.address1} ${mvo.address2}</textarea>
                </div>
            </div>
        </div>
	</div>
...
<legend>수령인 정보</legend>
		...
		<div class="form-card">
            ...
            <div class='form-group'>
              <div class='col-xs-12 form-group'>
                ...
                <input id="rphone" name="rphone" type="text" placeholder="01xxxxxxxxxx" class="form-control locked" required="">
              </div>
            </div>
            <div class='form-group'>
              <div class='col-xs-12 form-group'>
                <label class="control-label locked" for="rzipcode-input-field">우편번호</label>
                <input id="rzipcode" name="rzipcode" type="text" placeholder="xxxxx" class="form-control locked" required="">
              </div>
            </div>
            <div class="form-group locked">
                <div class='col-xs-12 form-group'>
                    <label class="control-label locked" for="raddress-input-field">주소</label>
                    <textarea name="raddress" id="raddress" cols="0" rows="3" class="form-control locked"></textarea>
                </div>
            </div>
            <div class='form-group'>
              <div class='col-xs-12 form-group'>
                <label class="control-label locked" for="msg-input-field">배송메세지</label>
                <input id="msg" name="msg" type="text" class="form-control locked" required="">
              </div>
            </div>
        </div>
	</div>	
	...
	<button class="pull-right" type="submit" onclick="sendData()">결제하기</button>
</div>
</form>
