...
.review:hover {
   background-color: rgb(20, 84, 109);
   ...
   <header>
      <div class="header-book">
         ...
         <div class="header-book-title">
            ...
            <div>
               <button class="btn"><i class="fas fa-cart-arrow-down"></i>장바구니담기</button>
               <button class="btn"><i class="far fa-credit-card"></i>바로구매</button>
               <button class="btn"><i class="fas fa-atlas"></i>E북으로 보기</button>
            </div>
         </div>
      </div>
   </header>
      ...
      <div class="main-book-flex">
         ...
         <div class="review">
            <a href="#" class="blue02" onclick="">이벤트</a>
               ...
               <!-- 리스트 타이틀 시작 -->
                 ;">
                     <div class="main-book-flex" style="height: 10%;">
                        <form style="display: flex; width: 100%; height: 100%; border:1px solid brown;">
                           <div style="width: 100%;  height: 100%;">
                              <textarea name="tag_save"  style="resize: none; width: 100%; height: 100%"></textarea>
                           </div>
