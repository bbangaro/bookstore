...
$("#getGo").ready(function(){
		...
		$.ajax("getBook?lcode="+lcode, {
			...
			success : function(data){
				...
				$.each(alist, function(index, member){
					...
					tbody += "<img src='bookimg/" + this.image + "'/><br>";
					tbody += this.name;
					tbody += "<br>";
	...
	$("#getGo2").click(function(){
		var lcode = $('#getGo2').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
	...
	$("#getGo3").click(function(){
		var lcode = $('#getGo3').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
	...
	$("#getGo4").click(function(){
		var lcode = $('#getGo4').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
	...
	$("#getGo5").click(function(){
		var lcode = $('#getGo5').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
