<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	$("#getNo2").click(function(){
		var lcode = $('#getNo2').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
	...
	$("#getNo3").click(function(){
		var lcode = $('#getNo3').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
	...
	$("#getNo4").click(function(){
		var lcode = $('#getNo4').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
	...
	$("#getNo5").click(function(){
		var lcode = $('#getNo5').val();
		$.ajax("getBook?lcode="+lcode, {
			type : "get",
			dataType : "json",
			success : function(data){
