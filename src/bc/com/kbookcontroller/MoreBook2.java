 ...
 */
@WebServlet("/morebook2")
public class MoreBook2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			List<BookVO> mlist2 = NotDAO.getMlist2(map);
			System.out.println("Mlist1 : "+mlist2);
			//JSON 형태의 문자열 작성
			/*
			 {"list" : [
			 	{
