 ...
 */
@WebServlet("/morebook3")
public class MoreBook3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			List<BookVO> mlist3 = NotDAO.getMlist3(map);
			System.out.println("Mlist1 : "+mlist3);
			//JSON 형태의 문자열 작성
			/*
			 {"list" : [
			 	{
