 ...
 */
@WebServlet("/morebook5")
public class MoreBook5 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			List<BookVO> mlist5 = NotDAO.getMlist5(map);
			System.out.println("Mlist1 : "+mlist5);
			//JSON 형태의 문자열 작성
			/*
			 {"list" : [
			 	{
